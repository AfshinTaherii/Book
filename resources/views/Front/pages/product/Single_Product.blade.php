...
{{--                                <a href="#"><img src="/Front/assets/img/shop-item1.jpg" alt="product-img"></a>--}}
{{--                            </div>--}}

{{--                            <div class="product-img">--}}
{{--                                <a href="#"><img src="/Front/assets/img/shop-item2.jpg" alt="product-img"></a>--}}
{{--                            </div>--}}

{{--                            <div class="product-img">--}}
{{--                                <a href="#"><img src="/Front/assets/img/shop-item3.jpg" alt="product-img"></a>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                    </div>--}}
            ...
            <div class="shop-details">
                <div class="row h-100 justify-content-center align-items-center">
                    <div class="col-lg-4 col-md-12">
                        <div class="product-img-slides">
                            <div class="product-img">
                                <a href="#"><img src="{{$data->cover_image}}" alt="product-img"></a>
                            </div>
                    ...
                    <div class="col-lg-8 col-md-12">
                        <div class="product-entry-summary">
                            <h3>{{$data->titleFa}}</h3>
                            @if($data->priceBook != $data->offPrice)
                                <h4><span>{{$data->priceBook}} تومان </span>{{$data->offPrice}} تومان </h4>
                            @else
                                <h4>{{$data->priceBook}} تومان</h4>
                            @endif
                            <p>{!!$data->descriptionFa!!}</p>
                            <form method="post" action="#">
                                @csrf
{{--                                <input name="id" value="{{$data->id}}" style="display: none;">--}}
                                <input type="number" name="quantity" title="Qty" value="{{$data->number}}"
                                       class="form-control">
                                <button class="btn btn-primary">افزودن به سبد خرید</button>
                            </form>
                        </div>
