                            ...
                            <div class="card-body">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link d-flex align-items-center active" id="account-tab"
                                           ...
                                           aria-controls="account" role="tab" aria-selected="true">
                                            <i class="feather icon-user mr-25"></i><span class="d-none d-sm-block">افزودن کاربر</span>
                                        </a>
                                    </li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane active" id="account" aria-labelledby="account-tab"
                                        ...
                                        @endif
                                        <form action="{{route('storeUser')}}" enctype="multipart/form-data"
                                              method="post">
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                               placeholder="تکرار رمز عبور" name="repeat">
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <fieldset class="form-group"><label for="image">انتخاب
                                                                    عکس</label>
