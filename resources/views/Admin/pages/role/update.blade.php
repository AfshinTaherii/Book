...
@section('content')
    ...
    <section class="vuexy-checkbox-color">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <form class="form" method="post" action="{{route('storeUpdateRoll')}}">
                        @csrf
                        <div class="card-header" style="border-bottom: #ffffff 1px solid;"><h4 class="card-title mb-2">
                                ویرایش کردن سطح دسترسی</h4></div>
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <li class="d-inline-block mr-2">
                                            <fieldset>
                                                <div class="vs-checkbox-con vs-checkbox-success"><input type="checkbox"
                                                                                                        name="groups"
                                                                                                        @if($role->groups ==1) checked @endif>
                                                    <span class="vs-checkbox"> <span class="vs-checkbox--check"> <i
                                                                class="vs-icon feather icon-check"></i> </span> </span>
                                        ...
                                        <li class="d-inline-block mr-2">
                                            <fieldset>
                                                <div class="vs-checkbox-con vs-checkbox-success"><input type="checkbox"
                                                                                                        name="product"
                                                                                                        @if($role->product ==1) checked @endif>
                                                    <span class="vs-checkbox"> <span class="vs-checkbox--check"> <i
                                                                class="vs-icon feather icon-check"></i> </span> </span>
                                        ...
                                        <li class="d-inline-block mr-2">
                                            <fieldset>
                                                <div class="vs-checkbox-con vs-checkbox-success"><input type="checkbox"
                                                                                                        name="slider"
                                                                                                        @if($role->slider ==1) checked @endif>
                                                    <span class="vs-checkbox"> <span class="vs-checkbox--check"> <i
                                                                class="vs-icon feather icon-check"></i> </span> </span>
                                        ...
                                        <li class="d-inline-block mr-2">
                                            <fieldset>
                                                <div class="vs-checkbox-con vs-checkbox-success"><input type="checkbox"
                                                                                                        name="settingContact"
                                                                                                        @if($role->settingContact ==1) checked @endif>
                                                    <span class="vs-checkbox"> <span class="vs-checkbox--check"> <i
                                                                class="vs-icon feather icon-check"></i> </span> </span>
                        ...
                        <input class="form-control" name="id" value="{{$role->id}}" style="display: none">
